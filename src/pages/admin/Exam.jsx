    ...
    <ExamContainer>
      ...
      <Content>
        ...
        <ExamForm onSubmit={handleAddExam}>
          ...
          <FormInput type="text" placeholder="Enter Name" required />
          ...
          <FormInput type="text" placeholder="Class" required />
          <FormLabel>Marks:</FormLabel>
          <FormInput type="number" placeholder="Enter Student Marks" required />
