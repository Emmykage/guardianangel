...
const galleryPhotos = [
  ...
  {
    src: "https://images.unsplash.com/photo-1560785496-3c9d7ecf5f46?w=600&q=80",
    alt: "Kids doing arts and crafts",
  },
  {
    src: "https://images.unsplash.com/photo-1510531704581-5b2870972060?w=600&q=80",
  ...
  {
    src: "https://images.unsplash.com/photo-1544717305-996b815c338c?w=600&q=80",
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(15,30,51,0.88) 0%, rgba(26,46,74,0.75) 50%, rgba(15,30,51,0.60) 100%)",
          }}
        />
        <div
              ...
              {stats.map((s, i) => (
                ...
                >
                  <p
                    ...
                    style={{ fontFamily: "'Georgia', serif", color: "#f0c040" }}
                  >
                    {s.value}
                  </p>
            ...
            <div className="grid grid-cols-2 gap-3">
              {quickLinks.map((link, i) => (
                <button
                  ...
                  onMouseOver={(e) => {
                    e.currentTarget.style.background = "rgba(240,192,64,0.18)";
      ...
      <section className="py-20">
        <div
          style={{
            background: "url(./logo.png) rgba(240,192,64,0.04) repeat",
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <div
            ...
            style={{ color: "rgba(240,192,64,0.4)" }}
          >
            "
          </div>
          <p
            className="text-xl md:text-2xl text-white font-medium leading-relaxed mb-6 italic"
            style={{ fontFamily: "'Georgia', serif" }}
          >
            My child looks forward to school every single day. The teachers here
            genuinely care and the mix of Montessori and Nigerian curriculum has
            made her so confident and curious.
          </p>
          <div className="flex items-center justify-center gap-3">
            <div
              className="w-px h-6"
              style={{ background: "rgba(240,192,64,0.4)" }}
            />
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm leading-relaxed mb-7">
                Reach out to our admissions team today and take the first step
