...
const newsData = [
  {
    ...
    image: "https://images.unsplash.com/photo-1532094349884-543559563b1e?w=600&q=80",
    featured: true,
  },
  {
    id: 2,
...
export default function SchoolNewsEvents() {
  ...
  return (
    ...
    >
        ...
        style={{ background: "linear-gradient(135deg, #1a2e4a 0%, #2d4a73 60%, #1a3a5c 100%)" }}
      >
        {/* Decorative circles */}
        <div className="absolute -top-16 -right-16 w-64 h-64 rounded-full opacity-10"
          style={{ background: "radial-gradient(circle, #f0c040, transparent)" }} />
        <div className="absolute bottom-0 left-1/3 w-96 h-32 opacity-5"
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-14">
          ...
          <p className="text-blue-200 text-lg max-w-xl" style={{ fontFamily: "system-ui, sans-serif", fontWeight: 300 }}>
            Stories, achievements, and upcoming moments from our school community.
          </p>

          {/* Tabs */}
          <div className="flex gap-2 mt-8" style={{ fontFamily: "system-ui, sans-serif" }}>
            {["news", "events"].map((tab) => (
              <button
                key={tab}
      ...
      {/* Filter bar */}
      <div className="max-w-6xl mt-10 mx-auto px-6 py-5 flex items-center gap-2 flex-wrap"
        ...
        {filters.map((f) => (
          <button
            ...
            style={
              activeFilter === f
                ? { background: "#1a2e4a", color: "white", borderColor: "#1a2e4a" }
        ...
        {activeTab === "news" && (
          <div>
            ...
            {featured && (activeFilter === "All" || activeFilter === featured.category) && (
              <div className="mb-10 rounded-2xl overflow-hidden shadow-lg flex flex-col md:flex-row"
                ...
                <div className="md:w-1/2 h-64 md:h-auto relative overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">
                    <span
                      ...
                      style={{ background: "#f0c040", color: "#1a2e4a", fontFamily: "system-ui, sans-serif" }}
                    >
                      Featured
                    </span>
                  </div>
                ...
                <div className="md:w-1/2 p-8 flex flex-col justify-center">
                  <div className="flex items-center gap-3 mb-4" style={{ fontFamily: "system-ui, sans-serif" }}>
                    <span className={`text-xs font-semibold uppercase tracking-wide px-2 py-1 rounded ${categoryColors[featured.category]}`}>
                      {featured.category}
                    </span>
                    <span className="text-xs text-gray-400">{featured.date}</span>
                  </div>
                  <h2 className="text-2xl font-bold mb-3" style={{ color: "#1a2e4a", lineHeight: 1.3 }}>
                    {featured.title}
                  </h2>
                  <p className="text-gray-500 leading-relaxed mb-6" style={{ fontFamily: "system-ui, sans-serif", fontSize: "0.95rem" }}>
                    {featured.excerpt}
                  </p>
                  <button
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {rest.map((article) => (
                ...
                >
                  ...
                  <div className="p-5">
                    <div className="flex items-center gap-2 mb-3" style={{ fontFamily: "system-ui, sans-serif" }}>
                      <span className={`text-xs font-semibold uppercase tracking-wide px-2 py-0.5 rounded ${categoryColors[article.category]}`}>
                        {article.category}
                      </span>
                    ...
                    <h3
                      ...
                      style={{ color: "#1a2e4a", fontSize: "1.05rem", textDecorationColor: "#f0c040" }}
                    >
                      {article.title}
                    </h3>
                    ...
                    <button
                      ...
                      style={{ color: "#2d4a73", fontFamily: "system-ui, sans-serif" }}
                    >
                      Read More →
                    </button>
                  </div>
          ...
          <div className="space-y-4">
            ...
            {filteredEvents.map((event) => (
              <div
                ...
                style={{ borderColor: "" }}
                onMouseOver={(e) => (e.currentTarget.style.boxShadow = "0 6px 24px rgba(26,46,74,0.10)")}
                onMouseOut={(e) => (e.currentTarget.style.boxShadow = "0 1px 3px rgba(0,0,0,0.05)")}
              >
                {/* Date badge */}
                <div
                ...
                >
                  <span className="text-xs font-bold uppercase tracking-widest" style={{ fontFamily: "system-ui, sans-serif" }}>
                    {event.month}
                  </span>
                  <span className="text-2xl font-bold leading-none" style={{ fontFamily: "'Georgia', serif" }}>
                    {event.day}
                  </span>
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <h3 className="font-bold text-lg" style={{ color: "#1a2e4a" }}>
                    {event.title}
                  </h3>
                  <div className="flex flex-wrap gap-4 mt-1 text-sm text-gray-500" style={{ fontFamily: "system-ui, sans-serif" }}>
