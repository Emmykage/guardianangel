    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(15,30,51,0.88) 0%, rgba(26,46,74,0.78) 60%, rgba(15,30,51,0.70) 100%)",
          }}
        />
        <div
        ...
        <div className="grid gap-14 md:grid-cols-2 items-center">
          ...
          <div>
            ...
            <p className="text-gray-500 leading-relaxed mb-5 text-sm">
              With over a decade of experience in quality education, Guardian
              Angel stands as a beacon of learning in Kubwa, Abuja. We combine
              strong academics with creativity, moral discipline, and a
            ...
            <p className="text-gray-500 leading-relaxed mb-4 text-sm">
              Founded to provide accessible, high-quality education to families
              in Abuja, Guardian Angel is rooted in values of honesty,
              discipline, and service. We are committed to developing young
              leaders with strong academic foundations and a lifelong love of
              learning.
            </p>
            <p className="text-gray-500 leading-relaxed text-sm">
              Our dedicated teachers and caregivers bring warmth and
              professionalism into every classroom — ensuring each child feels
              loved, supported, and encouraged to grow.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-3 md:grid-cols-5 gap-3">
            {[
              ...
              {
                src: "https://images.unsplash.com/photo-1560785496-3c9d7ecf5f46?w=500&q=80",
                alt: "Kids doing crafts",
              },
              {
              ...
              {
                src: "https://images.unsplash.com/photo-1510531704581-5b2870972060?w=500&q=80",
                alt: "Children playing",
              },
              {
                src: "https://images.unsplash.com/photo-1546410531-bb4caa6b424d?w=500&q=80",
      ...
      >
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-blue-200 mb-8 leading-relaxed text-sm">
            Contact our admissions office to learn more about our programmes and
