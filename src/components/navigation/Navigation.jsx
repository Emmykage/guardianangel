    ...
    <Navbar>
        ...
        <Linker href="#" className='navlink relative'> 
            ...
            <ul className='bg-theme/60 text-white top-full left-0 absolute border border-gray-200/30 shadow pl-3 pr-20 py-4 rounded-bl-xl rounded-br-xl'>
                <li><NavLink >Welcome </NavLink> </li>
                <li><NavLink>Vission and Mission </NavLink> </li>
                <li><NavLink>Meet Our Team </NavLink> </li>
                <li><NavLink>Board </NavLink> </li>
                <li><NavLink>Our Nursery </NavLink> </li>
        ...
        <Linker href="#"  className='navlink relative bg-green-400'>Parents
        <ul className='bg-purple-900 text-white top-full left-0 absolute border border-gray-200 shadow pl-3 pr-10 py-4 rounded-bl-xl rounded-br-xl'>
        ...
        <Linker href="#" className='navlink relative bg-green-400'>Children
        <ul className='bg-purple-900 text-white top-full left-0 absolute border border-gray-200 shadow pl-3 pr-10 py-4 rounded-bl-xl rounded-br-xl'>
        ...
        <Linker href="#" className='navlink relative bg-green-400'>Gallery</Linker>
        <Linker href="#" className='navlink relative bg-green-400'>Join Us
